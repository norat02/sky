...
var settingsOverlay=$('settingsOverlay'),settingsBtn=$('settingsBtn'),settingsClose=$('settingsClose'),languageSelect=$('languageSelect'),quickLocaleVi=$('quickLocaleVi'),quickLocaleEn=$('quickLocaleEn');
...
function closeLb(){lbSc.classList.add('hidden');if(titleSc.classList.contains('hidden')&&overSc.classList.contains('hidden'))titleSc.classList.remove('hidden');}
 ...
 if(quickLocaleVi)quickLocaleVi.addEventListener('click',function(){setLocale('vi',true);});
 if(quickLocaleEn)quickLocaleEn.addEventListener('click',function(){setLocale('en',true);});
